          ...
          {subscriptionStatus === "active" ? (
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2 text-xs text-gray-400">
                {["AI-powered market analysis", "Professional trading ladder", "Real-time Betfair data", "AI Guardian risk management", "7-day free trial"].map((f) => (
        ...
        <Card title="Trading Settings">
          <div className="space-y-4">
            ...
            <div className="border-t border-gray-800/50 pt-4 space-y-3">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-sm text-white">AI Analysis</div>
                  <div className="text-xs text-gray-500">Show AI market analysis</div>
                </div>
